...
{
    private IHostile _Holder { get; set; }
    ...
    public async void Shoot()
    {
        ...
        {
            Ammo--;
            foreach (RaycastHit hit in Physics.RaycastAll(_Holder.cameraPosition.position, _Holder.cameraFoward, Range, _Holder.EnemyLayer))
            {
